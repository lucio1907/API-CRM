...
const Cliente = ({cliente, handleEliminar}) => {
  ...
  return (
    <tr className="border-b hover:bg-gray-50">
        ...
        <td className="p-3">
            <p><span className="text-gray-800 uppercase font-bold mr-3">Email:</span>{email}</p>
            <p><span className="text-gray-800 uppercase font-bold mr-3">Teléfono:</span>{telefono}</p>
        </td>
